  ...
  return (
    <section className="pt-32 pb-12 px-6 overflow-hidden">
      <div className="container mx-auto">
        <div className="bg-urban-black rounded-[32px] p-8 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center justify-between min-h-[500px] border border-zinc-900 shadow-2xl">
          ...
          <div className="relative z-10 w-full md:w-1/2 flex justify-center mt-10 md:mt-0">
            <div className="w-64 h-80 md:w-80 md:h-96 bg-gradient-to-br from-zinc-900 to-black rounded-street border border-green-neon/30 flex items-center justify-center rotate-3 shadow-[0_0_50px_rgba(57,255,20,0.1)] relative animate-float">
              <span className="text-green-neon font-display text-9xl opacity-20">GG</span>
              <div className="absolute bottom-4 right-4 bg-zinc-800 text-white border border-zinc-700 font-sans font-bold px-4 py-2 rounded-lg transform rotate-[-3deg] shadow-lg">
                R$ 19,40
              </div>
            </div>
          </div>
